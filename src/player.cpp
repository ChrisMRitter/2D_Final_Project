...
Player::Player(std::string texturePath, float speed) {
  ...
  // Set initial position, origin, and scale of the sprite
...
// Set the player's position and update the hitbox accordingly
...
// Get the bounding box of the player's sprite (for collision, etc.)
...
void Player::handleInput(float dt, std::vector<Laser> &lasers,
  ...
  if (sf::Keyboard::isKeyPressed(sf::Keyboard::Space) &&
    ...
    laserSound.play(); // Play firing sound
...
// Placeholder for future animation handling
